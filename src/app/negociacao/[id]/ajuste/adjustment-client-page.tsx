        ...
        if (typeof window !== 'undefined') {
            try {
                ...
                if (item) {
                    ...
                    // For the specific tax-001 asset, force agreement states on initialization
...
export function AdjustmentClientPage({ asset, assetType }: { asset: Asset, assetType: AssetType }) {
  ...
  const [buyerAgrees, setBuyerAgrees] = usePersistentState<boolean>(`${negotiationId}_buyerAgrees`, false);
