...
export const placeholderRuralLands: RuralLand[] = [
  {
    ...
    businessType: 'Venda',
    location: 'Goiás, GO',
    images: ['/placeholder-images/rural-1-v2.jpg', '/placeholder-images/rural-2-v2.jpg', '/placeholder-images/rural-3-v2.jpg'],
  ...
  },
  {
    ...
    images: ['/placeholder-images/rural-4-v2.jpg', '/placeholder-images/rural-5-v2.jpg'],
  ...
  },
  {
    ...
    images: ['/placeholder-images/rural-6-v2.jpg', '/placeholder-images/rural-7-v2.jpg'],
  ...
  },
  {
    ...
    businessType: 'Venda',
    location: 'Bahia, BA',
    images: ['/placeholder-images/rural-8-v2.jpg', '/placeholder-images/rural-9-v2.jpg', '/placeholder-images/rural-10-v2.jpg'],
